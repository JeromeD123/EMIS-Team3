...
<form action="/action_page.php" mehtod = "POST">
  <div class="container">
...
<?php
	...
	$conn = OpenCon();
	$sql = "INSERT INTO Users (First Name, Last Name, Email, Password) VALUES ($_POST['FirstName'], $_POST['LastName'], $_POST['email'], $_POST['psw'])";
